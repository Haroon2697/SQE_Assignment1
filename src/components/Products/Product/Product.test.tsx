...
jest.mock('utils/formatPrice', () => {
  return jest.fn((price: number, currencyId: string) => {
    if (currencyId === 'BRL') {
...
// Mock image imports
jest.mock('static/products/12345-1-product.webp', () => 'mocked-image.webp');
...
describe('Product Component', () => {
  ...
  test('renders product information correctly', () => {
    renderWithThemeProvider(<Product product={mockProduct} />);
  ...
  test('does not render installment when not available', () => {
    ...
    renderWithThemeProvider(<Product product={productWithoutInstallments} />);
